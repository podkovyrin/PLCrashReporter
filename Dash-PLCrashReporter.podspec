...
Pod::Spec.new do |s|
  ...
  s.source_files  = "Source/**/*.{h,hpp,c,cpp,m,mm,s}",
                    "Dependencies/protobuf-c-1.3.2/src/*.c",
                    "Dependencies/protobuf-c-1.3.2/include/protobuf-c/*.h"
  ...
  <<-CMD
    ...
    find . \\( -iname '*.h' -o -iname '*.hpp' -o -iname '*.c' -o -iname '*.cc' -o -iname '*.cpp' -o -iname '*.m' -o -iname '*.mm' \\) -exec sed -i '' -e 's/#include <protobuf-c\\/protobuf-c.h>/#include "..\\/Dependencies\\/protobuf-c-1.3.2\\/include\\/google\\/protobuf-c\\/protobuf-c.h"/g' {} \\;
